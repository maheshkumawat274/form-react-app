                ...
                <div className="mt-3">
                    <div className="card text-left">
                        <div className="card-body">
                            <form onSubmit={props.submitdet}>
                            <div className="form-group">
                                    <label>
                                        <b>7.</b>
                                        Current Address
                                    </label>
                                    <input type="text" name="caddress" className="form-control" required autoComplete="off"></input>
                                </div>
                                <div className="form-group">
                                    <label>
                                        <b>8.</b>
                                    ...
                                    <input type="text" name="paddress" className="form-control" required autoComplete="off"></input>
                                </div>
                                <div className="form-group">
                                    <label>
                                        <b>9.</b>
                                    ...
                                    <input type="text" name="city" className="form-control" required autoComplete="off"></input>
                                </div>
                                <div className="form-group">
                                    <label>
                                        <b>10.</b>
                                    ...
                                    <select name="selectone"  class="form-control">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="number" className="form-control" name="pin" required autoComplete="off"></input>
                                </div>
                                <div className="form-group">
                                    <label>
                                        <b>12.</b>
                                    ...
                                    <select required name="nationality" className="form-control">
